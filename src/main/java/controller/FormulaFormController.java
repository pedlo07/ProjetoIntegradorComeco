...
public class  FormulaFormController implements Initializable {
    ...
    private Formula getFormData() {
        ...
        obj.setDescformula(txtEmail.getText());
    ...
    private void initializeNodes() {
        ...
        Constraints.setTextFieldMaxLength(txtEmail, 9999);
    ...
    public void updateFormData(){
        ...
        txtEmail.setText(entity.getDescformula());
    ...
    private void setErrorMessages(Map<String, String> errors){
        ...
        labelErrorEmail.setText((fields.contains("descformula") ? errors.get("descformula") : ""));
